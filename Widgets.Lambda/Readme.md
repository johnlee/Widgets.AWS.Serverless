...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Widgets.Lambda*):
...
Execute unit tests
```
    cd "Widgets.Lambda/test/Widgets.Lambda.Tests"
    dotnet test
```

Deploy application
```
    cd "Widgets.Lambda/src/Widgets.Lambda"
